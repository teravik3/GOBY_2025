...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final boolean kFrontLeftDriveReversed = false; //Q1
    public static final boolean kRearLeftDriveReversed = false; //Q2
    public static final boolean kRearRightDriveReversed = false; //Q3
    public static final boolean kFrontRightDriveReversed = false; //Q4

    public static final boolean kFrontLeftTurningMotorReversed = false; //Q1
    public static final boolean kRearLeftTurningMotorReversed = false; //Q2
    public static final boolean kRearRightTurningMotorReversed = false; //Q3
    public static final boolean kFrontRightTurningMotorReversed = false; //Q4
